...
fun newUsdtFragmentFragment(arrayList : ArrayList<String>) : Fragment{
...
class UsdtFragment : Fragment() {
    private var UsdtList : ArrayList<String> = arrayListOf()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bundle?.run {
            UsdtList = this.getStringArrayList("market")
        }
        setupApiService()
