...
class UpbitPresenter(
    ...
    override fun start() = showMarketPrice("KRW")

    override fun onTickerLoaded(marketPrice: List<UpbitTicker>) =
        upbitView.updateMarketPrice(NumberFormatter.convertTo(marketPrice))

    override fun onDataNotAvailable(t: Throwable) = upbitView.showErrMsg(t)

    override fun showMarketPrice(prefix: String) = upBitRepository.getMarketPrice(prefix, this)
}