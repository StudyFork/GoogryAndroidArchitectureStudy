...
안드로이드 아키텍쳐에 관하여 정말 많은 자료들이 있습니다. 그 중에서도 본 스터디는가장 짧고 빠르게 아키텍처에 관하여 공부 할 수 있습니다. 
커리큘럼은 MVC →MVP→ MVVM 으로 리팩토링하고 AAC, DI 까지 적용하며 안드로이드 개발자라면 한번쯤 들어 봤을 주제에 대하여 다 같이 공부 할 수 있는 기회가 생깁니다. 본 스터디를 마치면서 가장 좋았던 점은 아래와 같습니다. 

**- 다양한 사람들의 코드를 볼 수 있어서 좋았습니다.**
 똑같은 앱을 만들더라도 안의 코드는 개인마다 다 다르듯이 같은 기수마다 개발하는 방법과 작성한 코드가 다양합니다. 남의 코드와 본인의 코드를 비교하며 어떤 방향이 더 바람직한가가 스스로 생각 해 볼 수 있는 기회가 많았으며 Kotlin이나 Rx의 유용한 함수 등을 적용해 볼 수 있어서 좋았습니다.

**- 코드리뷰에 대한 기준이 생길 수 있습니다**
 개인적으로 코드 리뷰를 할 수 있는 기회는 흔치 않다고 생각합니다.  남의 코드에 Comment를 남길 때 어떠한 방향으로 남겨야 하는지 스스로 의문점이 생기는데 본 스터디를 통하여 코드 리뷰에 대한 기준이 생길 수 있었습니다. 

**- 자유롭게 물어보고 자문을 구할 개발자가 곁에 생긴다.**
 멘토님이 안드로이드 개발 관련 외에도 여러 툴이나 팁들을 알고 계셔서 이와 관련하여 좋은 정보를 얻을 수 있어서 좋았습니다. 이외에도 본 스터디가 끝나도 맘이 맞는 분들끼리는 지속적으로 스터디를  할 수 있으며,  평일에는 근무하고 주말에는 스터디를 하러 모이는 다른 개발자 분들을 보며 여러가지로 좋은 자극제가 되어서 스스로 더 열심히 해야겠다는 마음이 생겨났습니다. 

본 스터디는 Github으로 PR을 날리고, Slack을 통하여 개발 관련된 좋은 자료들을 서로 공유합니다. 스스로 욕심을 가지고 공부하고자 하시는 분들이 더 좋은 기회와 지식을 얻어 갈 수 있을 것이라고 생각합니다. 바쁜 회사 생활에서도 스터디를 통하여 더 열심히 하고 싶은 마음을 얻을 수 있었고, 땀흘리시면서 늘 라이브 코딩을 해주시며 석준님에게 감사드립니다. 4기 분들도 수고 많으셨습니다 😀
