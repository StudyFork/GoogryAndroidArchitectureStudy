...
class WebApiDefine {
    ...
    companion object {
        ...
        //오류
        private val ERROR_UNAUTHORIZED_ACCESS = 401  //허가되지않은 접속
        private val ERROR_REQUIRING_UPDATE = 403  //업데이트 필요
        private val ERROR_FROM_SERVER = 500  //서버오류
        private val ERROR_SERVER_CHECKING = 503  //서버점검/업데이트중
